...
const ClassDetail = () => {
  ...
  const handleReservar = () => {
    ...
    if (bookings.length > 0) return navigate('/agendar');
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center pt-32">
        <div className="animate-spin rounded-full h-10 w-10 border-b-2 border-dynamic-main" />
      </div>
    );
  }
      ...
      <div className="relative h-[50vh] md:h-[60vh] overflow-hidden">
        ...
        <div className="absolute top-24 left-0 right-0">
          <div className="container-custom">
            <Link
              to="/"
              className="inline-flex items-center text-white bg-black/30 backdrop-blur-md px-4 py-2 rounded-full hover:bg-black/50 transition-all mb-8"
            >
          ...
          <div className="lg:col-span-2 space-y-8">
            <section className="prose prose-lg max-w-none">
              ...
              <div className="mt-8 bg-dynamic-light/30 p-6 rounded-creeser border border-dynamic-main/10">
                <h3 className="text-xl font-bold text-dynamic-dark mb-2">
                  Nuestra Metodología
                </h3>
                <p className="text-dynamic-dark/80 italic">
                  &ldquo;{classItem.methodology}&rdquo;
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {classItem.schedules.map((schedule, idx) => (
                  <div
                    key={idx}
                    className="flex items-center p-4 bg-white rounded-creeser border border-gray-100 shadow-soft"
                  >
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 flex items-center">
                        <FaMapMarkerAlt className="mr-1" /> Sede{' '}
                        {schedule.location}
                      </p>
                    </div>
                  </div>
          ...
          <aside className="space-y-6">
            <div className="bg-white p-8 rounded-creeser border border-gray-100 shadow-soft sticky top-24">
              ...
              <div className="p-4 bg-gray-50 rounded-lg mb-8">
                ...
                <p className="text-3xl font-bold text-dynamic-main">
                  $30.000{' '}
              ...
              <Button
                ...
                className="w-full py-4 bg-dynamic-main hover:bg-dynamic-dark text-white text-lg"
              >
                Reservar Cupo
              </Button>
